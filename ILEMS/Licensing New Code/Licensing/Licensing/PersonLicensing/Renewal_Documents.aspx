<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Renewal_Documents.aspx.cs" MasterPageFile="../Master Page/frm.master" Inherits="Licensing.PersonLicensing.Renewal_Documents" %>
...
<asp:Content ID="cnt1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script type="text/javascript">
        ...
        var dataIn = '';
        var sa5 = new sagrid();
        sa5.url = "../WCFGrid/GridService.svc/BindPersonRenewalDocument";
        ...
        <div id='btnnew_pop' class="popup" style="display: none;">
            ...
            <table align="center" id="frmfld" class="spac">
                ...
                <tr class="hide">
                    ...
                    <td align="left">
                        <asp:DropDownList ID="ddl_cabinet" runat="server">
                            ...
                            <asp:ListItem Value="1055">Renewal</asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr class="hide">
                    ...
                    <td align="left">
                        <asp:DropDownList ID="ddl_folder" runat="server">
                            ...
                            <asp:ListItem Value="1410">2017 Renewal Documents</asp:ListItem>
                               <asp:ListItem Value="1460">2018 Renewal Documents</asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:DropDownList ID="ddl_year" runat="server" CssClass="required" error="Please enter year."></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:DropDownList ID="ddl_doctype" runat="server" CssClass="required" error="Please select the doc type.">
                            ...
                            <asp:ListItem Value="1055">Renewal</asp:ListItem>
                            <asp:ListItem Value="1355">Renewal Regulatory Questions</asp:ListItem>
                            <asp:ListItem Value="1231">Renewal Statement</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
    ...
    <script type="text/javascript">
        ...
        if (isedit == 'True' && isdel == 'True') {
            if (document.getElementById('<%=hfdutype.ClientID%>').value == "1")
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("License Type", "LiceseType"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Edit", "", "", "1", "1", "edit_lkp", "fa fa-pencil-square-o grdicon"), new dcol("Comments", "Comments"), new dcol("User", "UserName"), new dcol("Delete", "", "", "1", "1", "Delete_lkp", "fa fa-trash-o grdicon")];

            else
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Edit", "", "", "1", "1", "edit_lkp", "fa fa-pencil-square-o grdicon"), new dcol("Comments", "Comments"), new dcol("User", "UserName"), new dcol("Delete", "", "", "1", "1", "Delete_lkp", "fa fa-trash-o grdicon")];
        }
        else if (isedit == 'True') {
            if (document.getElementById('<%=hfdutype.ClientID%>').value == "1")
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("License Type", "LiceseType"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Edit", "", "", "1", "1", "edit_lkp", "fa fa-pencil-square-o grdicon"), new dcol("Comments", "Comments"), new dcol("User", "UserName")];

            else
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Edit", "", "", "1", "1", "edit_lkp", "fa fa-pencil-square-o grdicon"), new dcol("Comments", "Comments"), new dcol("User", "UserName")];
        }
        else if (isdel == 'True') {
            if (document.getElementById('<%=hfdutype.ClientID%>').value == "1")
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("License Type", "LiceseType"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Comments", "Comments"), new dcol("User", "UserName"), new dcol("Delete", "", "", "1", "1", "Delete_lkp", "fa fa-trash-o grdicon")];

            else
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Comments", "Comments"), new dcol("User", "UserName"), new dcol("Delete", "", "", "1", "1", "Delete_lkp", "fa fa-trash-o grdicon")];
        }
        else
        {
            if (document.getElementById('<%=hfdutype.ClientID%>').value == "1")
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("License Type", "LiceseType"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Comments", "Comments"), new dcol("User", "UserName")];

            else
                sa5.cols = [new dcol("Date", "Document_Date"), new dcol("Year", "RenewalYear"), new dcol("Document Type", "Values"), new dcol("Download", "", "", "1", "1", "down_lkp", "fa fa-download grdicon"), new dcol("File Name", "Description"), new dcol("Comments", "Comments"), new dcol("User", "UserName")];
        }

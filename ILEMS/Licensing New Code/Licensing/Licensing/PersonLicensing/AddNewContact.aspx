<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewContact.aspx.cs"
    Inherits="Licensing.PersonLicensing.AddNewContact" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function bindpersonsearch() {
            ...
            var stype = "1";
            if (document.getElementById('<%= rdbpersonlike.ClientID %>' + '_1').checked == true)
                stype = "0";
        ...
        function Select_lkp(sender, keyval) {
            ...
            document.getElementById('<%=ddlcontacttype.ClientID %>').value = '-1';
            document.getElementById('<%=txtcomment.ClientID %>').value = '';
            $('#addnew_pop').dialog({ title: "New Contact Details" });
    ...
    <script type="text/javascript">
        ...
        function Clear_search() {
            ...
            document.getElementById('<%= rdbpersonlike.ClientID %>' + '_0').checked = false;
            document.getElementById('<%= rdbpersonlike.ClientID %>' + '_1').checked = false;
    ...
    <script type="text/javascript">
        ...
        function bindbusinesssearch() {
            ...
            var stype = "1";
            if (document.getElementById('<%= rdbbusinesslike.ClientID %>' + '_1').checked == true)
                stype = "0";
            dataIn = dataIn + '"resptype":"' + stype + '"'
    ...
    <script type="text/javascript">
        ...
        function BusinessClear_search() {
            ...
            document.getElementById('<%= rdbbusinesslike.ClientID %>' + '_0').checked = false;
            document.getElementById('<%= rdbbusinesslike.ClientID %>' + '_1').checked = false;
    ...
    <script type="text/javascript">
        ...
        function InsertContact(pid) {
            document.getElementById('<%=hfdrelid.ClientID %>').value = pid;
            $(function () {
                $('#addnew_pop').dialog({ title: "New Contact Details" });
                $('#addnew_pop').dialog('open');
            });
        ...
        function Confirmation(businessname, licno, contacttype, comment) {
            document.getElementById('<%=hfdcontact.ClientID%>').value = contacttype;
            document.getElementById('<%=hfdcomment.ClientID%>').value = comment;
            if (contacttype == "3")
                cnfbox("This person is already supervisor at '" + businessname + ' , ' + licno + "'  .Do you wish to continue?", "cnffnres");
            else
                cnfbox("This person is already designated representative at '" + businessname + ' , ' + licno + "'  .Do you wish to continue?", "cnffnres");
        }
        function Warning(contacttype, comment) {
            document.getElementById('<%=hfdcontact.ClientID%>').value = contacttype;
            document.getElementById('<%=hfdcomment.ClientID%>').value = comment;
            cnfbox("Warning: Pharmacist on Probation. Do you wish to proceed?", "cnffnres");
        }
        ...
        function ShowPercentage() {
            if (document.getElementById('<%=ddlcontacttype.ClientID%>').value == "2")
                $('#Percentage').show();
            else
                $('#Percentage').hide();
        }
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:HiddenField ID="hfdcontact" runat="server" Value="0" />
            <asp:HiddenField ID="hfdcomment" runat="server" Value="0" />
            <asp:HiddenField ID="hfdpid" runat="server" Value="0" />
            <asp:HiddenField ID="hfdrelid" runat="server" Value="0" />
            <asp:HiddenField ID="hfdcontactid" runat="server" Value="0" />
        ...
        <div class="cpanel" id="personsearch">
            ...
            <div class="body" >
                <asp:Panel ID="pnl1" runat="server" DefaultButton="btnpersonsearch">
                <table align="center" class="spac">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rdbpersonlike" runat="server" RepeatColumns="2">
                    ...
                    <tr>
                        <td colspan="6" align="center" height="50px;">
                                 <asp:Button ID="btnpersonsearch" runat="server" Text="Search" OnClientClick="javascript:return Search_Validation();" />
                       
                            <asp:Button ID="btnpersonsearchclear" runat="server" Text="Clear" OnClientClick="javascript:return Clear_search();" />
        ...
        <div id="btnaddnewperson_pop" class="popup" style="display: none;">
            <span class="title">Add New Person</span>
              <asp:Panel ID="Panel1" runat="server" DefaultButton="btnpersonsave">
            ...
            <table align="center" class="spac" id="frmfld">
                ...
                <tr>
                    <td colspan="6" align="center">
                        <asp:Button ID="btnpersonsave" runat="server" Text="Save" OnClick="btnpersonsave_Click" OnClientClick="javascript:return PersonSave_Validation();" />
        ...
        <div class="cpanel" id="businesssearch">
            ...
            <div class="body">
                  <asp:Panel ID="Panel2" runat="server" DefaultButton="btnbusinesssearch">
                ...
                <table align="center" class="spac">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rdbbusinesslike" runat="server" RepeatColumns="2">
                                <asp:ListItem Value="0" Selected="True">Like</asp:ListItem>
                                <asp:ListItem Value="1">Exact</asp:ListItem>
                            </asp:RadioButtonList>
                    ...
                    <tr>
                        <td colspan="6" align="center" height="50px;">
                             <asp:Button ID="btnbusinesssearch" runat="server" Text="Search" OnClientClick="javascript:return BusinessSearch_Validation();" />
                           
                   
                            <asp:Button ID="btnbusinesssearchclear" runat="server" Text="Clear" OnClientClick="javascript:return BusinessClear_search();" />
        ...
        <div id="btnbusinessadd_pop" class="popup" style="display: none;">
            <span class="title">Add New Business</span>
              <asp:Panel ID="Panel3" runat="server" DefaultButton="btnbusinesssave">
            ...
            <table align="center" class="spac" id="frmfld1">
                ...
                <tr>
                    <td colspan="6" align="center">
                        <asp:Button ID="btnbusinesssave" runat="server" Text="Save" OnClick="btnbusinesssave_Click" OnClientClick="javascript:return BusinessSave_Validation();" />
            ...
            <div class="body">
                <table class="spac">
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlcontacttype" runat="server" onchange="javascript:return ShowPercentage();">
                               <asp:ListItem Value="0" Text="Select Contact Type"></asp:ListItem>
                                ...
                                <asp:ListItem Value="6" Text="Compliance Officer"></asp:ListItem>
                                 <asp:ListItem Value="7" Text="Key Holder"></asp:ListItem>
                                  <asp:ListItem Value="8" Text="Agent of Record"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr style="display:none" id="Percentage">
                        <td align="right">
                            Percentage
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txt_percentage" runat="server" placeholder="Percentage"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>

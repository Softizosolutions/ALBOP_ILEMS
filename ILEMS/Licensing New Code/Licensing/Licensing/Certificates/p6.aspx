...
<body>
   ...
   <asp:DataList ID="dtlst" runat="server" Width="100%" class="grd">
    <ItemTemplate>
        ...
        <DIV id="page_1" >
<DIV id="dimg1" style="margin-top:10px"  >
  ...
  <b>Non-Resident Pharmacy <%# GetLictype_pharmacy(Eval("LicenseType_ID").ToString(),Eval("Person_ID").ToString()) %></b>
  ...
  <div id="cs" <%# iscs(Eval("CS").ToString()) %>>
    ...
    <div style="font-weight:normal;text-align:right;display:block;margin-top:45px;margin-right:100px;">
      <div style="width:700px">
     <span><%#Schedule(Eval("Schedules").ToString()) %> </span>
    <span style=" margin-left:75px;">Non-Resident Pharmacy <%# GetLictype_pharmacy(Eval("LicenseType_ID").ToString(),Eval("Person_ID").ToString()) %> </span>
    <span style=" margin-left:50px;"><%# Eval("csissue") %></span>
    </div>
    
    
    </div>
     <div style="font-size:13pt; font-weight:normal;text-align:right;display:block;margin-top:45px;margin-right:120px;">

...
<DIV id="dimg1" style="margin-top:20px"  >
  ...
  <div style="font-size:16pt; font-weight:normal;text-align:left;display:block;text-align:left;margin-left:150px;margin-top:50px">
  <b>Pharmacy Services Permit</b>
  ...
  <div id="cs" <%# iscs(Eval("CS").ToString()) %>>
    ...
    <span style=" margin-left:70px;">Pharmacy Services Permit</span>
  ...
  <%# Eval("oname") %>
   ...
   <%# Eval("City") %>, <%# Eval("state") %> <%# Eval("Zip") %></div>
    ...
    <div id="ncs" <%# isnotcs(Eval("CS").ToString()) %>>
      <div style="font-size:52pt;color:brown;font-weight:bold;text-align:left;display:block;margin-top:500px">

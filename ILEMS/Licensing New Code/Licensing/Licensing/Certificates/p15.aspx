...
<br /><br /><br /><br /> 
 ...
 <p style="font-size:20pt;font-weight:bold;margin-top:10px;margin-bottom:10px;line-height:1.5;margin-left:auto;margin-right:auto;width:50%;text-align:center">
 <%# Eval("oname") %>
 </p> 
...
in accordance with laws regulating the practice of
pharmacy, and<br /> the rules and Regulations of the Board.<br />

...
<DIV id="dimg1" style="margin-top:20px"  >
  ...
  <b>Institutional Pharmacy <%# GetLictype_pharmacy(Eval("LicenseType_ID").ToString(),Eval("Person_ID").ToString()) %></b>
  ...
  <div id="cs" <%# iscs(Eval("CS").ToString()) %>>
    ...
    <span style=" margin-left:60px;">Institutional Pharmacy <%# GetLictype_pharmacy(Eval("LicenseType_ID").ToString(),Eval("Person_ID").ToString()) %></span>

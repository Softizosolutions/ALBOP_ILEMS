...
<DIV id="dimg1" style="margin-top:20px"  >
  ...
  <b><%#Eval("License_Type") %></b>
  
  </div>  
     <div style="margin-top:47px;float:right;margin-right:240px">
      <span style="font-size:12pt;"><%# Convert.ToDateTime(Eval("expdt")).ToString("MM/dd/yyyy")%></span>
  ...
  <div id="cs" <%# iscs(Eval("CS").ToString()) %>>
    ...
    <span style=" margin-left:60px;">$600.00</span>
    </div>
    </div>
    ...
    <span style=" margin-left:160px;"><%#Getlicshort(Eval("License_Type").ToString()) %></span>
    <span style=" margin-left:50px;"><%# Eval("csissue") %></span>
    </div>
    
    
    </div>
    <div style="font-size:13pt; font-weight:normal;text-align:right;display:block;margin-top:45px;margin-right:95px;">

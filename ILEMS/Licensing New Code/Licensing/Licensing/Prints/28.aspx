...
<xml>
  <w:WordDocument> 
    ...
    <title></title>
      ...
      <body lang=EN-US>
<div class="Section1">
	<table id="tbmain" align="left" border="0" cellpadding="0" cellspacing="0" class="MsoNormalTable" style="width:95.0%;border-collapse:collapse;margin-left:7.1pt;
 margin-right:7.1pt">
	<tbody>
		<tr style="height:.2in">
  ...
  solid #999999 1.0pt;padding:0in 5.75pt 0in 5.75pt;height:.2in" width="518">
				<h2 align="center">
					ARIZONA STATE BOARD OF PHARMACY</h2>
				<h2 align="center">
  ...
  padding:0in 5.75pt 0in 5.75pt;height:.2in" width="312">
				<p class="Body" style="width:146%">
					<b>Agency Name:&nbsp;&nbsp;&nbsp; Arizona State Board of Pharmacy </b></p>
			</td>
  ...
  border-top:none;padding:0in 5.75pt 0in 5.75pt;height:.2in" width="311">
				<p class="Body">
					<b>Name:&nbsp;</b><%= Getval("RespondentName") %></p>
			</td>
			<td colspan="8" style="width:182.6pt;border-top:none;border-left:
  none;border-bottom:solid #999999 1.0pt;border-right:solid #999999 1.0pt;
  padding:0in 5.75pt 0in 5.75pt;height:.2in" width="243">
				<p class="Body">
					<b>License/Registration #:&nbsp;</b><%= Getval("RespondantLicense") %></p>
			</td>
			<td colspan="3" style="width:107.9pt;border-top:none;border-left:
  none;border-bottom:solid #999999 1.0pt;border-right:solid #999999 1.0pt;
  padding:0in 5.75pt 0in 5.75pt;height:.2in" width="144">
				<p class="Body">
					<b>Arrested:</b></p>
			</td>
		</tr>
  ...
  border-top:none;padding:0in 5.75pt 0in 5.75pt;height:.2in" width="699">
				<p class="Body">
					<b>Address 1:&nbsp;</b><%= Getval("RespondentAddress1") %></p>
			</td>
		</tr>
		<tr style="height:.2in">
			<td colspan="17" style="width:523.95pt;border:solid #999999 1.0pt;
  border-top:none;padding:0in 5.75pt 0in 5.75pt;height:.2in" width="699">
				<p class="Body">
					<b>Address 2:&nbsp;</b><%= Getval("RespondentAddress2") %></p>
			</td>
		</tr>
		<tr style="height:.2in">
			<td colspan="6" style="width:233.45pt;border:solid #999999 1.0pt;
  border-top:none;padding:0in 5.75pt 0in 5.75pt;height:.2in" width="311">
				<p class="Body">
					<b>Phone:&nbsp;</b><%= Getval("RespondentPhone") %></p>
			</td>
			<td colspan="11" style="width:290.5pt;border-top:none;border-left:
  none;border-bottom:solid #999999 1.0pt;border-right:solid #999999 1.0pt;
  padding:0in 5.75pt 0in 5.75pt;height:.2in" width="387">
				<p class="Body">
					<b>Email:&nbsp;</b><%= Getval("RespondentEmail") %></p>
			</td>
		</tr>
		<tr style="height:.2in">
			<td colspan="11" style="width:369.1pt;border:solid #999999 1.0pt;

    ...
    <body lang=EN-US> 
        <div class="Section1" style="line-height:3px; line-height:15px" > 
                ...
                <tr>
                  ...
                  (205) 981-2330 Fax <br /> 
                   ...
                   <td style="text-align:center;font-size:16pt; font:Arial";> <b>   ALABAMA <br /> BOARD OF PHARMACY </b>
                       <br /> <br /> 
                   <img src= '<%=System.Configuration.ConfigurationManager.AppSettings["lmslink"].ToString()+"/images/Albop_logo.jpg" %>'  style="width:150px; height:150px;" />

               </td> 
                    <td style="text-align:center;  font-size:10pt; font:Arial";>
             <u>     MEMBERS 2020  </u> <br /> <br />
            ...
            <table  width="98%">
                ...
                <tr>
                    <td style="padding-left:28px">
                       <br /><b> CASE #:</b>&nbsp;<%= Getval("Complaint_Number") %>
                    </td>
                </tr>
            <tr>
            ...
            <tr><td style="padding-left:28px"> <b>ADDRESS: </b>__________________________________________________________________________<br /> ___________________________________________________________________________________</td></tr>
                         <tr>
                        <td style="padding-left:28px"><br />
                            <b><I>Please note: The administrative hearing will proceed as scheduled with or without your <br />attendance.</I></b>
					</td>
                             </tr>
                    </table> 
                <table width="98%">
                   ...
                   <%-- <tr>
                       <td style="padding-left:28px"><br /><spane style="font-size:20px;" > &#9633; </spane> <b>   I DO </b>plan to attend the Hearing.     <br />                           
                        ...
                        <tr>
                            <td style="padding-left:28px">   <br />                           
                          <span style="font-size:20px;" > &#9633; </span> <b> I WILL NOT</b> be represented by an Attorney  <br />                               
                            </td>
                        </tr>
                        <tr><td style="padding-left:28px">                              
                           <span style="font-size:20px;" > &#9633; </span><b>  I WILL</b> be represented by the Attorney listed below: <br /> <br />                               
                            </td>
                        </tr>
                        <tr>

...
{
    public partial class CRC : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                PersonLicensing.Utilities_Licensing.BindDropdownForCRCandHearing(ddl_doctype, 67,1);
            }
        }
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (hfdselid.Value == "0")
            {
                ...
                if (obj.Count > 0)
                   // Mail.SendMail("", "pwright@albop.com;canderson@albop.com;ebraden@albop.com", "", "Document Upload", "A new document has been Uploaded By : " + obj[0].CreatedBy + " For Licensee’s Name : " + obj[0].Full_Name + "<br/>Case # : " + obj[0].Case_No + "<br/>License # : " + obj[0].Lic_No + "<br/>Document Type :" + ddl_doctype.SelectedItem.Text + "<br/>Filename :" + upddocument.PostedFile.FileName);
        ...
        protected void btndownloadall_ServerClick(object sender, EventArgs e)
        {
            ...
            if (obj != null)
                ZipfileName = "CRC Documents For - " + obj.Complaint_Number + ".Zip";
            else
            ...
            try
            {
                List<USP_GetAllDocumentsDownloadCRCResult> Getdocuments = Person_Details.Licensing_Details.GetAlldocumentsDownloadCRC(Convert.ToInt32(hfdcmpid.Value), Convert.ToInt32(hfdperid.Value));
